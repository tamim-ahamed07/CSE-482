    ...
    <div class="container mt-3">
      <div class="row">
        <div class="col-lg-5 border border-secondary rounded mb-1 p-3 mx-auto pt-5 mt-3">
          ...
          ?>
          <h4 class="text-center text-secondary p-3 bg-success rounded">Admin Sign Up</h4>
          <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a href="adminlogin.php" class="text-muted ml-3">Already have an account? Login here</a>
          </form>
        </div>
